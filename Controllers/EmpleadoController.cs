...
namespace ProjectControlBodega.Controllers
{
    public class EmpleadoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Cedula,Nombres,Apellidos,Sexo,Edad,Numero")] Empleado empleado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Cedula,Nombres,Apellidos,Sexo,Edad,Numero")] Empleado empleado)
        {
            if (id != empleado.Id)
            {
                return NotFound();
